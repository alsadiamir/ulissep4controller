...
def main(p4info_file_path, bmv2_file_path):
    ...
    try:
        ...
        #writeIpv4Rules(p4info_helper, sw_id=s2, dst_ip_addr="10.0.2.2", port = 255)
        #writeIpv4Rules(p4info_helper, sw_id=s3, dst_ip_addr="10.0.3.3",  port = 255)
        ...
        while True:
            sleep(2)
            print("Trying to spot a PacketIn...")
