import sys
sys.path.append('/usr/lib/python3/dist-packages') # workaround for bmpy_utils and bm_runtime. these are not pip installations but come with behavioural model installation
import json
